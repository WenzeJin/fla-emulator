...
#Q = {0,cp,cmp,mh,accept,accept2,accept3,accept4,halt_accept,reject,reject2,reject3,reject4,reject5,halt_reject,test_state}
...
F = {halt_accept} ; syntax error here
